...
// No phone tab bar: below lg the masthead is two tiers (brand with the theme button and SIGN IN,
// then the nav strip). The landing's section anchors live in the footer. These specs hold that on a phone.
