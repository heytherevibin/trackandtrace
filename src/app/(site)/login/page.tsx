...
import { googleSignInEnabled, passkeysEnabled } from "@/services/env";
...
export default async function LoginPage({ searchParams }: { searchParams: Promise<{ error?: string | string[] }> }) {
  ...
  return <LoginForm configured={isSupabaseConfigured()} google={googleSignInEnabled()} passkey={passkeysEnabled()} error={typeof error === "string" ? error : null} />;
}
