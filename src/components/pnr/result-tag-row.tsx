 ...
 * ("Sample data" for the fixture, "Third-party" for RapidAPI), and the PNR at the right in 13px figures.
 */
export function ResultTagRow({ tag, source, pnr, status }: { readonly tag: string; readonly source: PnrSource; readonly pnr: string; readonly status?: string }) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2.5">
      ...
      {sourceTag === "thirdParty" ? (
        <Badge variant="outline" title={messages.common.thirdPartyHint}>
