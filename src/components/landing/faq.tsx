      ...
      <div className="mt-[28px] max-w-faq border-t border-line">
        {m.items.map((item) => (
          <details key={item.q} className="border-b border-line">
            <summary className="cursor-pointer list-outside px-1 py-4 max-sm:list-inside font-display text-lg font-semibold leading-normal tracking-head">{item.q}</summary>
